...
func TestValidateTopic(t *testing.T) {
	...
	broker, _ := kafkautil.NewMockFromCluster(server.client, cluster)
	broker.CreateTopic(&kafkautil.CreateTopicOptions{Name: "test-topic", ReplicationFactor: 1, Partitions: 2})
