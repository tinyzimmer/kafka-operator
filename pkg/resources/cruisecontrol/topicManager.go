...
func newCruiseControlTopic(cluster *v1alpha1.KafkaCluster) *v1alpha1.KafkaTopic {
...
func generateCCTopic(cluster *v1alpha1.KafkaCluster, client client.Client, log logr.Logger) error {
