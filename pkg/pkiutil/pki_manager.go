...
import (
	...
	"github.com/banzaicloud/kafka-operator/pkg/pkiutil/certmanagerpki"
	"github.com/banzaicloud/kafka-operator/pkg/pkiutil/pkicommon"
	"github.com/banzaicloud/kafka-operator/pkg/pkiutil/vaultpki"
...
func GetPKIManager(client client.Client, cluster *v1alpha1.KafkaCluster) pkicommon.PKIManager {
...
func newMockPKIManager(client client.Client, cluster *v1alpha1.KafkaCluster) pkicommon.PKIManager {
